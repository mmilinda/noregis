          ...
          <div className={`p-3 sm:p-3.5 rounded-xl border-2 transition-all flex items-center justify-between gap-2 sm:gap-3 ${
            ...
            <div className="flex items-center gap-2 sm:gap-2.5 min-w-0 flex-1">
              ...
              <div className="min-w-0 flex-1">
                <h4 className="text-xs font-black uppercase tracking-wider truncate">Formulaire {activeDocType}</h4>
                <p className="text-[10px] font-bold opacity-80 mt-0.5 truncate">
                  {docCategory === 'NO_ID' ? "Visiteur enregistré sans pièce d'identité" : "Adapté au document détecté"}
                </p>
              </div>
            </div>
